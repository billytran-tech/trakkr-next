      ...
      <Link
        ...
        className={
          pathname?.includes('/account')
            ? 'group flex items-center px-3 py-2 text-sm leading-5 font-medium text-white rounded-md bg-transparent hover:bg-gray-700 focus:outline-none  focus:bg-gray-700 transition ease-in-out duration-150'
      ...
      <Link
        ...
        className={
          pathname === '/account/billing'
            ? 'mt-1 group flex items-center px-3 py-2 text-sm leading-5 font-medium text-white rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700 transition ease-in-out duration-150'
            : 'mt-1 group flex items-center px-3 py-2 text-sm leading-5 font-medium text-white rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150'
        }
      >
        <svg
          className={`flex-shrink-0 -ml-1 mr-3 h-6 w-6 transition ease-in-out duration-150 ${
            pathname === '/account/billing'
              ? 'text-white group-'
              : 'text-white group-focus:text-gray-500'
          }`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
